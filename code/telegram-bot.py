...
from database import daoImage, daoUser, daoQuestion, daoCurrentQuestions
import utils
...
def begin_therapy(update: Update, context: CallbackContext) -> int:
    ...
    #La primera pregunta siempre sera una pregunta "de tiempo" predefinida, valida para cuelquier tipo de foto
    ...
    daoCurrentQuestions.set_user_current_questions(update.message.from_user.id, questions)
